        ...
        <div className="row justify-content-center">
            <div className="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
                ...
                <ul className="list-unstyled">
                    <li><a className="link-secondary" href="#">Web design</a></li>
                    <li><a className="link-secondary" href="#">Development</a></li>
                    <li><a className="link-secondary" href="#">Hosting</a></li>
                </ul>
            </div>
            <div className="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
                <h3 className="fs-6">About</h3>
                <ul className="list-unstyled">
                    <li><a className="link-secondary" href="#">Company</a></li>
                    <li><a className="link-secondary" href="#">Team</a></li>
                    <li><a className="link-secondary" href="#">Legacy</a></li>
                </ul>
            </div>
            <div className="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
                <h3 className="fs-6">Careers</h3>
                <ul className="list-unstyled">
                    <li><a className="link-secondary" href="#">Job openings</a></li>
                    <li><a className="link-secondary" href="#">Employee success</a></li>
                    <li><a className="link-secondary" href="#">Benefits</a></li>
                </ul>
            </div>
            <div className="col-lg-3 text-center text-lg-start d-flex flex-column align-items-center order-first align-items-lg-start order-lg-last item social">
                <div className="fw-bold d-flex align-items-center mb-2"><span className="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center bs-icon me-2"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-bezier">
